...
public class MapConstants {
    ...
    public static final int MAX_Y = MAP_TILES_HEIGHT - 1;
    public static final int TILE_WIDTH = 10;
    public static final int TILE_HEIGHT = 10;
    public static final int MAP_SPACING = 10;
    public static final int MAP_WIDTH = MAP_TILES_WIDTH * TILE_WIDTH;
    public static final int MAP_HEIGHT = MAP_TILES_HEIGHT * TILE_HEIGHT;
